class PostsController < ApplicationController
  ...
  def create
    ...
    if @post.save
      ...
      redirect_to user_path(@post.user.username), notice: "Something went wrong while creating a post."
    end
  ...
  def update
    if @post.update(post_params)
      ...
      redirect_to post_path(@post), notice: "Something went wrong while updating the post."
    end
  end
